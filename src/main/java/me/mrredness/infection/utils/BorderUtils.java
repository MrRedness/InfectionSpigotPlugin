...
public class BorderUtils {
    ...
    public static boolean checkBorder() {
        if (DataHelper.contains("Infection Spawn World")) {
            String worldName = (String) DataHelper.get("Infection Spawn World");
            return Config.getBorders().containsKey(worldName);
        }
        return false;
    }

    public static boolean checkBorder(String worldName) {
        return Config.getBorders().containsKey(worldName);
    }
